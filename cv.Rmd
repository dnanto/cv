...
detailed_entries(
  tribble(
    ~what, ~when, ~with, ~where, ~why,
    "Scientist", "Aug 2011 – Present", "Noblis, Inc.", "Reston, VA",
    c(
    ...
    "On-Call Technical Intern", "Aug 2011 – Oct 2011", NA, NA,
    c(
    ...
    "Jun 2011 – Aug 2011", "Infant & Toddler Connection of Fairfax-Falls Church", "Fairfax, VA",
    c(
    ...
    "Undergraduate Researcher", "2008 – 2009", "Experimental Condensed Matter Physics, Boston University", "Boston, MA",
    c(
